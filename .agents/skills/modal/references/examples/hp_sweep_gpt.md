...
```python
base_image = modal.Image.debian_slim(python_version="3.11").uv_pip_install("pydantic==2.9.1")
...
ui_image = web_image.uv_pip_install("gradio~=4.44.0").add_local_dir(assets_path, remote_path="/assets")
```
