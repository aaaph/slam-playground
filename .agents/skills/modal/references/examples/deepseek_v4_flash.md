...
```python
sglang_image = sglang_image.env({"HF_HUB_CACHE": HF_CACHE_DIR, "HF_XET_HIGH_PERFORMANCE": "1"})
...
flashinfer_cache_vol = modal.Volume.from_name("flashinfer-autotune-cache", create_if_missing=True)
