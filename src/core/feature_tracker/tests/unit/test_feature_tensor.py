...
class TestFeatureTensor:
    ...
    def feature_row(  # noqa: PLR0913, PLR0917
        ...
        row[FeatureSchema.FRAME_PIXEL_DISPLACEMENT] = 0.0
        return row
    ...
    def test_get_free_indexes_method(self):
        ...
        tensor = FeatureTensor(feat_capacity=10)
    ...
    def test_add_method_with_feat_deep(self):
        ...
        tensor = FeatureTensor(feat_capacity=4)
        timestamp = 1
        tensor.add(1, timestamp, (0, 0), (1, 1), FeatureLifecycle.ACTIVE)
    ...
    def test_feature_row_adapts_to_feature_schema(self):
        ...
        assert row[FeatureSchema.FRAME_PIXEL_DISPLACEMENT] == 0.0
