...
class AsyncFoxgloveServerListener(ServerListener):
    """Foxglove server listener."""

    logger = spawn_logger(app="foxglove_server_listener")

    def __init__(self, client_connected_event: asyncio.Event) -> None:
        """Initialize the Foxglove server listener."""
        super().__init__()
        self.subscribers: dict[int, set[str]] = {}
        self.client_connected_event = client_connected_event
