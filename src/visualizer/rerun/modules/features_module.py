...
class FeaturesModule(IVizModule):
    ...
    def __init__(
        ...
        self.color_palette = self.options.color_palette
    ...
    def process(self, context: Ctx) -> None:
        ...
        if self.show_stereo_baseline:
            ...
            stereo_radii = np.full(len(stereo_mask), max(self.radii - 1, 1.0))
            rr.log(
    ...
    def __repr__(self) -> str:
        ...
        show_stereo_baseline = self.options.show_stereo_baseline
        show_feature_labels = self.options.show_feature_labels
        return (
            "FeaturesModule("
            f"entity_path={self.entity_path}, "
            f"property_name={self.property_name}, "
            f"radii={radii}, "
            f"show_stereo_baseline={show_stereo_baseline}, "
            f"show_feature_labels={show_feature_labels})"
        )
